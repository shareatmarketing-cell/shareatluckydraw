...
const Navbar = () => {
  ...
  const navLinks = [
    { path: "/", label: "Home", icon: Gift },
    { path: "/winners", label: "Winners", icon: Trophy },
    { path: "/enter", label: "Enter Draw", icon: Gift },
  ];
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <motion.div
              ...
              className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-gradient-to-br from-primary to-primary-glow flex items-center justify-center shadow-glow-primary"
            >
            ...
            <div className="hidden sm:block">
              ...
              <span className="block text-xs text-muted-foreground -mt-1">Lucky Draw</span>
            </div>
          </Link>
